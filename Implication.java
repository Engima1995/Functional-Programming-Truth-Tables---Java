...
public class Implication extends BinaryOp {
	...
	public Implication(Expr x1, Expr x2) {
	...
	public Function<Boolean, Function<Boolean, List<Boolean>>> operator() {
		return x -> y -> List.single(!x || y);		//Evaluates the values as IMPLICATION and stores it in to List of type Boolean and returns it
	}
